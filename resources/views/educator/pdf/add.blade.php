...
@section('content')
    <form action="{{route('store_pdf', [$class])}}"  class="form" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group mt-5">
          ...
          <input type="text" class="form-control" id="code" name="name" placeholder="عنوان ليتمكن الطالب من تمييز المذكرات" value="{{old('name')}}" required>
          @error('name')
        ...
        <div class="row g-2 mt-5">
      	  ...
      	  <div class="col-md">
      	    <div class="form-floating">
      	      <input type="url" name="pdf_url" class="form-control" id="floatingInputGrid" placeholder="https://..." value="{{old('pdf_url')}}">
