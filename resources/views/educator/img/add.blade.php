...
@endsection
@section('content')
    <form action="{{route('store_img', [$class])}}"  class="form" method="post" enctype="multipart/form-data">
        @csrf

        <h2>إضافة صورة حصة</h2>

        <div class="form-group mt-5">
            <label for="name">العنوان</label>
          <input type="text" class="form-control" id="code" name="name" placeholder="عنوان ليتمكن الطالب من تمييز الصور" value="{{old('name')}}" required>
          @error('name')
        ...
        <div class="row  mt-5">
      	  ...
      	  <div class="col-md">
      	    <div class="form-floating">
      	      <input type="file" name="img" class="form-control" id="pdf">
